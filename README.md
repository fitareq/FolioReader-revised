# FolioReader-revised
Revised Version of FolioReader-Android

![FolioReader logo](https://raw.githubusercontent.com/FolioReader/FolioReaderKit/assets/folioreader.png)

[![](https://jitpack.io/v/fitareq/FolioReader-revised.svg)](https://jitpack.io/#fitareq/FolioReader-revised)
...
Add following dependency to your `settings.gradle` file:
...
dependencies {
    ...
    implementation 'com.github.fitareq:FolioReader-revised:$latest_version'
    ...
}
```
...
### Usage
Implement `OnHighlightListener`, `ReadLocatorListener`, `OnClosedListener`

Set configuration for `FolioReader`:
...
```kotlin
 FolioReader.get()
            ...
            .setScreenShotEnabled(false) //default value is true
            .setCopyEnabled(false) //default value is true
