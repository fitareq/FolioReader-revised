...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    private lateinit var buttonVertical: com.folioreader.util.StyleableTextView
    private lateinit var buttonHorizontal: com.folioreader.util.StyleableTextView
    private lateinit var view_config_font_andada: StyleableTextView
    private lateinit var view_config_font_lato: StyleableTextView
    private lateinit var view_config_font_lora: StyleableTextView
    private lateinit var view_config_font_raleway: StyleableTextView
    ...
    private fun initLayoutViews(view: View) {
